/**
 * DOP Lead Capture — Cloudflare Pages Function
 * Route: POST /api/lead
 * Env (Cloudflare dashboard → Settings → Environment variables):
 *   - BREVO_API_KEY (Secret) — wymagane
...
async function deliverLeadMagnet({ apiKey, leadEmail, firstName, siteUrl }) {
  const SITE_URL = siteUrl || 'https://doskonalaobslugapacjenta.pl';
...
<tr><td style="padding:32px">
 ...
 <p style="margin-top:36px;font-size:14px;color:#1A1A1A;line-height:1.5">Powodzenia we wdrażaniu,<br><strong style="color:#1B2C4F;font-family:Georgia,serif;font-size:18px">— Michał Katarzyński</strong></p>
